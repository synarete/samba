				       ...
				       struct messaging_debug *msg)
{
	...
	if (msg->version != MESSAGING_DEBUG_VERSION_1) {
...
enum ndr_err_code messaging_req_debuglevel_push_v1(
	...
	DATA_BLOB *blob)
{
	msg->version = MESSAGING_DEBUGLEVEL_VERSION_1;
	return ndr_push_struct_blob(blob,
				    mem_ctx,
				    msg,
				    (ndr_push_flags_fn_t)
...
enum ndr_err_code messaging_profile_push_v1(TALLOC_CTX *mem_ctx,
					    ...
					    DATA_BLOB *blob)
{
	msg->version = MESSAGING_PROFILE_VERSION_1;
	return ndr_push_struct_blob(blob,
				    mem_ctx,
				    msg,
				    (ndr_push_flags_fn_t)
					 ...
					 struct messaging_profile *msg)
{
	...
	if (msg->version != MESSAGING_PROFILE_VERSION_1) {
		return NDR_ERR_VALIDATE;
	}
...
enum ndr_err_code messaging_req_profilelevel_push_v1(
	TALLOC_CTX *mem_ctx,
	struct messaging_req_profilelevel *msg,
	DATA_BLOB *blob)
{
	msg->version = MESSAGING_PROFILELEVEL_VERSION_1;
	...
	struct messaging_req_profilelevel *msg)
{
	...
	if (msg->version != MESSAGING_PROFILELEVEL_VERSION_1) {
		return NDR_ERR_VALIDATE;
	}
...
enum ndr_err_code messaging_profilelevel_push_v1(
	TALLOC_CTX *mem_ctx,
...
enum ndr_err_code messaging_ping_push_v1(TALLOC_CTX *mem_ctx,
					 ...
					 DATA_BLOB *blob)
{
	msg->version = MESSAGING_PING_VERSION_1;
	msg->info.info1.payload = payload;
	return ndr_push_struct_blob(blob,
				    mem_ctx,
				    msg,
				    (ndr_push_flags_fn_t)
				      ...
				      struct messaging_ping *msg)
{
	...
	if (msg->version != MESSAGING_PING_VERSION_1) {
		return NDR_ERR_VALIDATE;
	}
...
enum ndr_err_code messaging_shutdown_push_v1(TALLOC_CTX *mem_ctx,
					     struct messaging_shutdown *msg,
					     DATA_BLOB *blob)
{
	msg->version = MESSAGING_SHUTDOWN_VERSION_1;
	msg->info.info1 = (struct messaging_shutdown_v1){};
	return ndr_push_struct_blob(blob,
				    mem_ctx,
				    msg,
				    (ndr_push_flags_fn_t)
					  ...
					  struct messaging_shutdown *msg)
{
	...
	if (msg->version != MESSAGING_SHUTDOWN_VERSION_1) {
		return NDR_ERR_VALIDATE;
	}
