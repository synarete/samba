	...
	DATA_BLOB *blob)
{
	...
	return ndr_push_struct_blob(
		...
		mem_ctx,
		msg,
		(ndr_push_flags_fn_t)ndr_push_messaging_force_election_v1);
}

enum ndr_err_code messaging_force_election_v1_pull(
	TALLOC_CTX *mem_ctx,
	const DATA_BLOB *blob,
	struct messaging_force_election_v1 *msg)
{
	...
	ndr_err = ndr_pull_struct_blob(
		...
		mem_ctx,
		msg,
		(ndr_pull_flags_fn_t)ndr_pull_messaging_force_election_v1);
	if (!NDR_ERR_CODE_IS_SUCCESS(ndr_err)) {
		return ndr_err;
	}
...
enum ndr_err_code messaging_daemon_ready_fd_v1_push(
	TALLOC_CTX *mem_ctx,
	...
	DATA_BLOB *blob)
{
	...
	return ndr_push_struct_blob(
		...
		mem_ctx,
		msg,
		(ndr_push_flags_fn_t)ndr_push_messaging_daemon_ready_fd_v1);
}

enum ndr_err_code messaging_daemon_ready_fd_v1_pull(
	TALLOC_CTX *mem_ctx,
	const DATA_BLOB *blob,
	struct messaging_daemon_ready_fd_v1 *msg)
{
	...
	ndr_err = ndr_pull_struct_blob(
		...
		mem_ctx,
		msg,
		(ndr_pull_flags_fn_t)ndr_pull_messaging_daemon_ready_fd_v1);
	if (!NDR_ERR_CODE_IS_SUCCESS(ndr_err)) {
		return ndr_err;
	}
