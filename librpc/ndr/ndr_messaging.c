...
static void messaging_version_set(enum messaging_version_values *version)
{
	*version = MESSAGING_VERSION_CURRENT;
}

static bool messaging_version_check(enum messaging_version_values version)
{
	return version == MESSAGING_VERSION_CURRENT;
}
